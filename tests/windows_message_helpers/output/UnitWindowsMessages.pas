...
uses FMX.Controls, FMX.Forms, FMX.Graphics, FMX.ListBox, FMX.Memo, FMX.Types, System.Classes,
  System.SysUtils, System.UIConsts, System.UITypes, System.Variants, Winapi.Messages, Winapi.Windows;
type
...
var
  ...
  wStr: string;
begin
  GeneratedFMXMemoLineScroll(MemImpPre, 0);
  GeneratedFMXMemoLineScroll(Memo1, -3);
  Line := GeneratedFMXMemoLineFromChar(Memo1, Memo1.SelStart);
  Line := GeneratedFMXMemoLineFromChar((Sender As TMemo), (Sender As TMemo).SelStart);
  GeneratedFMXMemoVScroll(Memo1, 'SB_TOP', 0);
  GeneratedFMXMemoVScroll((Sender As TMemo), 'SB_LINEDOWN', 0);
  wStr := 'abc';
  IndexVerbe := GeneratedFMXListBoxSelectString(ListBox1, wStr);
end;
end.
